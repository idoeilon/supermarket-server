...
CREATE TABLE `cart_items` (
  ...
  `items_total_price` int DEFAULT NULL,
...
CREATE TABLE `carts` (
  ...
  PRIMARY KEY (`cart_id`),
  KEY `cart_items_idx` (`cart_items_id`),
  CONSTRAINT `cart_items` FOREIGN KEY (`cart_items_id`) REFERENCES `cart_items` (`cart_item_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'supermarket_db'
--
...
-- Dump completed on 2022-07-05 21:01:35
